Ext.define('Security.view.organization.CreateOrganization', {
    extend: 'Ext.container.Container',
    alias : 'widget.createorganization',
    layout:'fit',
    minHeight:1000,
    autoScroll:true,
    ...
    this.items= [
        {
            ...
            items:[
                {
                    xtype:'component',
                    html:'<a href="#" id="manageTenantOrganizations-link" class="redirectURL quickLinks">BACK TO ORGANIZATIONS LIST</a>',
                    listeners : {
                ...
                {
                    xtype:'component',
                    html:'<h1>Create Organization</h1>'
                },
                {
                    xtype:'component',
                    margin:'30 0 0 0',
                ...
                },
                {
					...
					msgTarget: 'side',
                    id:'createOrganization-canonicalName',
                ...
                },
                {
					...
					regexText: '# check that the string contains *only* one or more alphanumeric chars or underscores',
					msgTarget: 'side',
                    id:'createOrganization-description',
