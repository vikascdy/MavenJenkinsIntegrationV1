 ...
 */
public class TestPermissionSet1 extends DriverBase{
    ...
    public void validatePermiissionSet1(){
        ...
        createTenantPage.createNewTenant(tenant + "child", description + "this has been created by Automation test case", domain + "child");
        Reporter.log("after validatePermiissionSet1" , true);
    }

    public void givePermissionSet1(){

        tenantRolePermissions.clickPermissionTabs();

        tenantRolePermissions.editSite();
        tenantRolePermissions.viewSite();
        tenantRolePermissions.createTenant();
        tenantRolePermissions.viewTenant();

        tenantRolePermissions.clickSaveButton();
        Reporter.log("after givePermissionSet1" , true);
    }
}
