 ...
 */
public class TestPermissionSet4 extends DriverBase {
    ...
    public void validatePermissionSet4() {
        ...
        createTenantRolePage.CreateRole(role + " child ", description
                + " child " + "this has been created by Automation test case");
        HtmlReporter.log("after validatePermissionSet4", true);
    }

    public void givePermissionSet4() {
        ...
        tenantRolePermissions.createRole();
        tenantRolePermissions.viewRole();

        tenantRolePermissions.clickSaveButton();
        HtmlReporter.log("after givePermissionSet4", true);
    }
}
