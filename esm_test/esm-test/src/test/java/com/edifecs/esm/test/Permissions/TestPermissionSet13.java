...
public class TestPermissionSet13 extends DriverBase{
	...
	private WebDriver webDriver;
	    ...
	    public void validatePermissionSet13() {
	        ...
	        tenantConfigurationMenu.ClickManageRoles();
	        tenantRolePage.DeleteRole(1);
	        HtmlReporter.log("after validatePermissionSet13", true);
	    }

	    public void givePermissionSet13() {
	        ...
	        tenantRolePermissions.deleteRole();
	        tenantRolePermissions.viewRole();

	        tenantRolePermissions.clickSaveButton();
	        Reporter.log("after givePermissionSet13", true);
	    }
}
