 ...
 */
public class TestPermissionSet9 extends DriverBase{
	...
	public void validatePermissionSet9(){
		...
		createOrganizationUserPage.CreateStandardUser(username, password, password, fName, mName, lName, title, "new"+email);
		HtmlReporter.log("after validatePermissionSet9", true);
			
	}
	
	public void givePermissionSet9(){
		...
		tenantRolePermissions.createUser();
		
		tenantRolePermissions.clickSaveButton();
		HtmlReporter.log("after after PermissionSet9", true);
	}	
}
