 ...
 */
public class TestPermissionSet6 extends DriverBase{
	...
	public void validatePermissionSet6(){
		...
		organizationOverviewPage.UpdateOrganizationOverview(organization," this description is being changed by automatiion test case ");
		Reporter.log("after validatePermissionSet6" , true);
	}
	
	public void givePermissionSet6(){
		...
		tenantRolePermissions.editOrg();
		
		tenantRolePermissions.clickSaveButton();
		Reporter.log("after givePermissionSet6" , true);
	}	
}
