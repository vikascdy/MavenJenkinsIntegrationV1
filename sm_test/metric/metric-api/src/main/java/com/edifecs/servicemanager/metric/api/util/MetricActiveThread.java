 ...
 */
public class MetricActiveThread extends Thread {
    private static Logger log = LoggerFactory.getLogger(MetricActiveThread.class);
    ...
    public MetricActiveThread(MetricsContainer metricsContainer, String hostName, InetAddress serverAddress, int serverPort, int refreshInterval) {
        running = true;
    ...
    private synchronized void sendMetrics(int delay, List<String> keyList) throws Exception {
        if (log.isDebugEnabled()) {
        ...
        for (String keyName : keyList) {
            ...
            try {
                ...
                log.error("zabbix agent not able to get value for key : " + keyName + " ignoring this key");
