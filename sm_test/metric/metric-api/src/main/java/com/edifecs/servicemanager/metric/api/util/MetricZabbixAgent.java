 ...
 */
public class MetricZabbixAgent {
    private static Logger log = LoggerFactory.getLogger(MetricZabbixAgent.class);
    ...
    private MetricActiveThread activeThread;
     ...
     */
    public MetricZabbixAgent() throws Exception {
    ...
    public void start() throws Exception {
        ...
        if (enableActive) {
            ...
            activeThread = new MetricActiveThread(metricsContainer, hostName, serverAddress, serverPort, refreshInterval);
            activeThread.start();
     ...
     *                      system.
     * @throws java.net.UnknownHostException when the provided address does not match one of the active
