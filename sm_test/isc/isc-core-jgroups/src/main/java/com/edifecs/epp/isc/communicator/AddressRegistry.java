 ...
 * addresses with the JGroups cluster registry. It is used to see what is
...
public class AddressRegistry implements IAddressRegistry {
    ...
    private final Map<Address, org.jgroups.Address> registeredNodes = new ConcurrentHashMap<>();
    ...
    public final void registerNode(final Address nodeAddress, final org.jgroups.Address address) {
        if (nodeAddress != null) {
    ...
    public final void updateRegistry(final List<org.jgroups.Address> viewMembers) {
        ...
        // Register new Nodes
        for (org.jgroups.Address address : viewMembers) {
    ...
    public org.jgroups.Address getAddressForNode(final Address nodeAddress) {
        if (nodeAddress != null) {
    ...
    public Address getAddressForNodeName(final String nodeName) {
        for (Entry<Address, org.jgroups.Address> address : registeredNodes.entrySet()) {
