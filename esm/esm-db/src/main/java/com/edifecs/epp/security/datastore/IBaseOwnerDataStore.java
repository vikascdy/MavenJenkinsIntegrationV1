 ...
 * @author i-adamnels
 */
public interface IBaseOwnerDataStore<T extends Serializable> extends IBaseDataStore<T> {

	T create(T prototype, User auditor) throws ItemAlreadyExistsException, SecurityDataException;

    T update(T updated, User auditor) throws ItemNotFoundException, SecurityDataException;
