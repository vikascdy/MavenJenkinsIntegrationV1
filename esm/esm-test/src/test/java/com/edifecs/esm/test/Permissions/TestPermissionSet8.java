 ...
 */
public class TestPermissionSet8 extends DriverBase{
	...
	public void validatePermissionset8(){
		...
		tenantConfigurationMenu.ClickManageRoles();
		tenantRolePage.editRole(roleNo, role, " this description is being changed by automatiion test case ");
		Reporter.log("after validatePermissionset8" , true);	
	}
	
	public void givePermissionSet8(){
		...
		tenantRolePermissions.editRole();
		
		tenantRolePermissions.clickSaveButton();
		Reporter.log("after givePermissionSet8" , true);
	}	
}
