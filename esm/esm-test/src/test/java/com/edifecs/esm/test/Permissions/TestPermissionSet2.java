 ...
 */
public class TestPermissionSet2 extends DriverBase{
    ...
    public void givePermission(){
        ...
        HtmlReporter.log("after givePermission" , true);Reporter.log("after LoginAdmin" , true);
    }

    @Test(dependsOnMethods = "givePermission")
    public void validatePermissionSet2(){
        ...
        createTenantOrganizationPage.CreateNewOrganization(organization+"Child" , "child"+description+ "this has been created by Automation test case");
        HtmlReporter.log("after validatePermissionSet2", true);
    }
    public void givePermissionSet2(){

        tenantRolePermissions.clickPermissionTabs();

        tenantRolePermissions.editSite();
        tenantRolePermissions.viewSite();
        tenantRolePermissions.createOrg();
        tenantRolePermissions.viewOrg();
        tenantRolePermissions.viewTenant();

        tenantRolePermissions.clickSaveButton();
        HtmlReporter.log("after givePermissionSet2" , true);
    }
}
